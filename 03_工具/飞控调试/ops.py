...
用法（在本目录或 03_工具/飞控调试/ 下）：
  ...
  python ops.py params-diff ../../01_设计/V6X_ardupilot_params.param
...
CMDS = {
    ...
    "params-export": ("verify_params.py", "阶段0", "参数全量备份到 01_设计/参数备份/"),
...
def menu():
    print("现场操作命令菜单（对应 12_使用说明书/现场操作_上电到遥控手动飞行实施步骤.md）\n")
